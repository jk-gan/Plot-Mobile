            ...
            try {
                ...
                if(jsonArr != null) {
                    ...
                    for(int i = 0; i < length; i++) {
                        ...
                        allItems.add(new Shop(jsnObj2.optString("name"), jsnObj2.optString("address"), R.drawable.profile, jsnObj2.optString("id"), jsnObj2.getJSONObject("image").getJSONObject("medium").optString("url")));
                    }
