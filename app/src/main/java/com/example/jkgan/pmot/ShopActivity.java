...
public class ShopActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        collapsingToolbar.setTitle("Shops");
        ...
        btnSubscribe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Snackbar.make(v, "Subscribed to the shop", Snackbar.LENGTH_LONG).show();
            }
        });
...
//        TextView txtShopName = (TextView) rootView.findViewById(R.id.textViewShopName);
//        txtShopName.setText(getActivity().getIntent().getStringExtra("NAME"));
//        return rootView;
//    }
}
